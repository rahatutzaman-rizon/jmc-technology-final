...
const services = [
  ...
  },
  {
    ...
    icon: <FaDev className="w-12 h-12" />,
        ...
        <Tab.Group selectedIndex={selectedIndex} onChange={setSelectedIndex}>
          <Tab.List className="flex flex-wrap justify-center gap-2 mb-12">
            {services.map((service, index) => (
              <Tab
                ...
                className={({ selected }) =>
                  classNames(
                    'px-4 py-2 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200',
                    selected
          ...
          <Tab.Panels>
            {services.map((service, idx) => (
              <Tab.Panel
                key={idx}
                className="bg-white rounded-xl shadow-lg p-6 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
                <motion.div 
                ...
                >
                  ...
                  <p className="text-gray-600 text-center mb-8 max-w-2xl">{service.description}</p>
