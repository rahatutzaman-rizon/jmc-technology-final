...
//                     <Link
//                       // href={`/dashboard/edit-blog/${item.id}`}>
...
const AllBlogsTable = () => {
  ...
  const dummyData = Array.from({ length: 20 }, (_, i) => ({
    ...
    date: "2024-09-30T09:31:47.982Z",
    category: "Beach",
    title: "xxxxxxxxxxxx",
    descriptions: "<p>xxxxxxxxxxxxx</p>",
    seoDescriptions: "xxxxxxxxxxxx",
    imagePath: "uploads/1727688707975-3.png",
    tags: ["xxxxx"],
    _id: "66fa70038b551b78744e9282",
    comments: [],
    ratings: [],
    __v: 0,
  }));
