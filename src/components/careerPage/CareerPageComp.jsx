...
// import SingleBlogCard from "../blogsPage/SingleBlogCard";
// import SingleJobCard from "./SingleJobCard";

// const CareerPageComp = () => {
//   const [{ isLoading, error, careers }, setCareersData] = useState({
//     isLoading: true,
//     error: null,
//     careers: null,
//   });
...
//       try {
//         setCareersData((prevState) => ({
//           ...prevState,
//           isLoading: true,
//         }));
//         const response = await import("../../assets/fake-jsons/careers.json");
//         setCareersData({
//           isLoading: false,
//           error: null,
//           careers: response.default,
//         });
//       } catch (error) {
//         setCareersData((prevState) => ({
//           ...prevState,
...
//               {careers?.slice(0, 7).map((career, index) => (
//                 <SingleJobCard key={index} career={career} />
//               ))}
//             </div>
//           </div>
//         </>
